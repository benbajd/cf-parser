...
class Configs:
    ...
    item_text_editor_command_wait: ConfigItemTerminal[list[str]]  # the command that open the text editor and waits
    item_cpp_header: ConfigItemFile[str]  # the cpp header
    # config item lists
    items_terminal: list[Union[
        ConfigItemTerminal[str],
        ConfigItemTerminal[Folder],
        ConfigItemTerminal[list[str]]
    ]]  # list of all config items in the terminal
    items_file: list[ConfigItemFile[str]]  # list of all config items in a file

    def __init__(self, configs_folder: Folder, message: Messages, print_running: bool) -> None:
        '''
        Init Configs.
        ...
        self.item_text_editor_command_wait = ConfigItemTerminal(
        ...
        self.items_terminal = [
            ...
            self.item_text_editor_command_wait
        ]
        self.items_file = [
    ...
    def edit_configs(self) -> None:
        ...
        for config_item_file in self.items_file:
            config_item_file.text_editor_command_wait = self.text_editor_command_wait
    ...
    @property
    def text_editor_command_wait(self) -> list[str]:
        '''
        Get the text editor wait command.
        :return: the text editor wait command
        '''
        assert self.item_text_editor_command_wait.value is not None
        return self.item_text_editor_command_wait.value
